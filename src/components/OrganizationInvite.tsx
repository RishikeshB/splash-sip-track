...
import { Building, Users, BarChart3, Shield, Zap, CheckCircle, ArrowRight, Crown, Target, Award } from 'lucide-react';
    ...
    <section className='py-20 px-4 bg-gradient-ocean'>
      <div className='container mx-auto'>
        <div className='text-center mb-16'>
          ...
          <h2 className='text-4xl md:text-5xl font-bold text-gradient mb-6'>Transform Your Organization's Wellness</h2>
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Boost productivity, reduce sick days, and build a healthier workplace culture with organization-wide
            hydration programs.
          </p>
        </div>
        ...
        <div className='bg-card/50 rounded-2xl p-8 mb-16 border border-primary/20'>
          <div className='text-center mb-8'>
            <h3 className='text-2xl font-bold text-gradient mb-4'>Enterprise Features</h3>
            <p className='text-muted-foreground'>Everything you need to manage hydration at scale</p>
          </div>
        ...
        <div className='space-y-8 mb-16'>
          <div className='text-center'>
            <h3 className='text-2xl font-bold text-gradient mb-4'>Choose Your Plan</h3>
            <p className='text-muted-foreground'>Flexible pricing that scales with your organization</p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            {plans.map((plan, index) => (
              <Card
                key={index}
                className={`p-6 glass-card hover:shadow-drop transition-flow ${
                  index === 1 ? 'border-primary/50 shadow-water' : ''
                }`}
              >
                <div className='text-center space-y-4'>
                  ...
                  <div>
                    ...
                    <div className='text-3xl font-bold text-gradient mb-1'>{plan.price}</div>
                    <p className='text-sm text-muted-foreground'>{plan.period}</p>
                  </div>

                  <p className='text-muted-foreground text-sm'>{plan.description}</p>

                  <div className='text-sm font-medium text-primary'>{plan.maxUsers}</div>
        ...
        <div className='bg-gradient-primary rounded-2xl p-8 md:p-12 text-center text-white'>
          <div className='max-w-3xl mx-auto space-y-6'>
            ...
            <h3 className='text-3xl font-bold'>Proven ROI for Your Organization</h3>
