      ...
      <div className='container mx-auto text-center'>
        <div className='max-w-4xl mx-auto space-y-8'>
          ...
          <div className='space-y-6'>
            <h1 className='text-5xl md:text-7xl font-bold text-gradient leading-tight'>Water Reminder</h1>
            ...
            <p className='text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed'>
              Transform your hydration habits with smart reminders, progress tracking, and team collaboration. Stay
              healthy, boost productivity, and build lasting wellness routines.
            </p>
          </div>
